...
#include "miryoku_layer_alternatives.h"
      ...
      #define MIRYOKU_LAYER_BASE MIRYOKU_ALTERNATIVES_BASE_WORKMAN
        ...
        #define MIRYOKU_LAYER_BASE MIRYOKU_ALTERNATIVES_BASE_QWERTY_split_3x6_3
      #else
  ...
  #define MIRYOKU_LAYERMAPPING_BASE MIRYOKU_MAPPING
    ...
    #elif defined (MIRYOKU_EXTRA_COLEMAKDH)
      #if FORCE_LAYOUT==split_3x6_3
        #define MIRYOKU_LAYER_EXTRA MIRYOKU_ALTERNATIVES_BASE_COLEMAKDH_split_3x6_3
      #else
  ...
  #define MIRYOKU_LAYERMAPPING_TAP MIRYOKU_MAPPING
      ...
      #if FORCE_LAYOUT==split_3x6_3
        #define MIRYOKU_LAYER_BUTTON MIRYOKU_ALTERNATIVES_BUTTON_split_3x6_3
      #else
  ...
  #define MIRYOKU_LAYERMAPPING_BUTTON MIRYOKU_MAPPING
      ...
      #if FORCE_LAYOUT==split_3x6_3
        #define MIRYOKU_LAYER_NAV MIRYOKU_ALTERNATIVES_NAV_VI_split_3x6_3
      #else
  ...
  #define MIRYOKU_LAYERMAPPING_NAV MIRYOKU_MAPPING
    ...
    #elif defined (MIRYOKU_NAV_VI)
      #if FORCE_LAYOUT==split_3x6_3
        #define MIRYOKU_LAYER_MOUSE MIRYOKU_ALTERNATIVES_MOUSE_VI_split_3x6_3
      #else
  ...
  #define MIRYOKU_LAYERMAPPING_MOUSE MIRYOKU_MAPPING
    ...
    #elif defined (MIRYOKU_NAV_VI)
      #if FORCE_LAYOUT==split_3x6_3
        #define MIRYOKU_LAYER_MEDIA MIRYOKU_ALTERNATIVES_MEDIA_VI_split_3x6_3
      #else
  ...
  #else
    #if FORCE_LAYOUT==split_3x6_3
      #define MIRYOKU_LAYER_NUM MIRYOKU_ALTERNATIVES_NUM_split_3x6_3
    #else
  ...
  #else
    #if FORCE_LAYOUT==split_3x6_3
      #define MIRYOKU_LAYER_SYM MIRYOKU_ALTERNATIVES_SYM_split_3x6_3
    #else
  ...
  #else
    #if FORCE_LAYOUT==split_3x6_3
      #define MIRYOKU_LAYER_FUN MIRYOKU_ALTERNATIVES_FUN_split_3x6_3
    #else
